...
def mime_email(subject, from_address, to_address, cc_address=None, bcc_address=None, text_message=None, html_message=None):
...
def lambda_handler(event, context):
    ...
    try:
        ...
        try:
            ...
            logger.info('Failed to read text message file. Did you upload %s?'
                        % args['plain_text_template'] if 'plain_text_template' in args else 'plain_text_template')
        try:
            ...
            logger.info('Failed to read html message file. Did you upload %s?'
                        % args['html_template'] if 'html_template' in args else 'html_template')
        ...
        for recipient in recipients:
            ...
            cc_address = recipient['email_address_cc'] if 'email_address_cc' in recipient else None
            bcc_address = recipient['email_address_bcc'] if 'email_address_bcc' in recipient else None
            ...
            if mime_message_text:
                t = Template(mime_message_text, variable_start_string='[[', variable_end_string=']]')
